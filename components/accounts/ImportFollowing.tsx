...
import { CheckSquare, Square, Upload, UserPlus } from "lucide-react";
...
type ImportFollowingProps = {
  ...
  /** Fires after a successful import — lets a dialog wrapper close itself. */
  onImported?: () => void;
};
...
export function ImportFollowing({ groups, bulkAddAction, onImported }: ImportFollowingProps) {
