...
export const trendsAr: TrendsDict = {
  trends: {
    page: {
      title: "رادار المجال",
      subtitle:
        "ما يتفوق أداؤه الآن عبر جميع الحسابات التي يتابعها مستخدمو ريل سباي — مرتّبًا وفق أداء كل حساب مقارنة بمستواه المعتاد، بحيث يمكن لحساب صغير في مجاله أن يتفوق على حساب ضخم. ذكاء تجميعي مجهول الهوية.",
