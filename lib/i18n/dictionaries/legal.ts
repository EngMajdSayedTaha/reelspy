...
export const legalAr: LegalDict = {
  legal: {
    ...
    privacy: {
      ...
      metaDescription: "كيف تجمع ReelSpy بياناتك وتستخدمها وتحميها.",
      updatedDate: "2026-07-03",
      intro:
        "توضّح سياسة الخصوصية هذه كيفية قيام ReelSpy («نحن») بجمع معلوماتك واستخدامها وحمايتها عند استخدامك لتطبيق ReelSpy. باستخدامك ReelSpy، فإنك توافق على الممارسات الموضحة في هذه السياسة.",
      sections: {
        collection: {
        ...
        use: {
          ...
          items: [
            "توفير خدمة ReelSpy وصيانتها وتحسينها.",
        ...
        subprocessors: {
          ...
          intro:
            "نعتمد على الجهات الخارجية التالية لمعالجة البيانات من أجل تشغيل ReelSpy. تتلقى كل جهة البيانات اللازمة لوظيفتها فقط، بموجب التزاماتها الخاصة بالأمان والخصوصية:",
          providers: {
        ...
        dpo: {
          ...
          before:
            "تعالج ReelSpy البيانات الشخصية بما يتوافق مع قانون حماية البيانات الشخصية الإماراتي (PDPL). لتقديم طلبات أو أسئلة متعلقة بحماية البيانات — الوصول أو التصحيح أو التصدير أو الحذف أو الاعتراض — تواصل مع مسؤول حماية البيانات لدينا على ",
          after: ".",
        },
      },
    },
    terms: {
      title: "شروط الخدمة",
      metaDescription: "الشروط التي تحكم استخدامك لـ ReelSpy.",
      updatedDate: "2026-07-03",
      intro:
        "تحكم شروط الخدمة هذه («الشروط») وصولك إلى ReelSpy واستخدامك لها («ReelSpy»، «نحن»، «لنا»). بإنشائك لحساب أو استخدامك للخدمة، فإنك توافق على هذه الشروط. إذا كنت لا توافق عليها، فيرجى عدم استخدام ReelSpy.",
      sections: {
        service: {
          heading: "1. الخدمة",
          body: "ReelSpy أداة لبحث المحتوى وإنشائه موجهة لصنّاع المحتوى على منصات التواصل الاجتماعي. تساعدك على تتبع الريلز وتحليلها، وإنشاء نصوص بمساعدة الذكاء الاصطناعي، وجدولة المحتوى أو نشره على المنصات المرتبطة. تختلف الميزات باختلاف الباقة، وقد تتغير مع تطوّر المنتج.",
        },
        eligibility: {
        ...
        yourContent: {
          heading: "6. محتواك",
          body: "تحتفظ بملكية المحتوى الذي ترفعه أو تُنشئه أو تنشره عبر ReelSpy. وأنت تمنحنا الترخيص المحدود اللازم لتخزين ذلك المحتوى ومعالجته ونقله لتشغيل الخدمة (على سبيل المثال، إرسال فيديو إلى منصة اخترت النشر عليها). أنت المسؤول عن المحتوى الذي تنشره وعن امتلاكك للحقوق اللازمة له.",
        },
        aiOutput: {
          heading: "7. المخرجات المُنشأة بالذكاء الاصطناعي",
          body: "تُنتَج النصوص والاقتراحات بمساعدة نماذج ذكاء اصطناعي من أطراف ثالثة وتُقدَّم كمسودات. قد تكون المخرجات غير دقيقة أو تشبه مواد أخرى؛ وأنت المسؤول عن مراجعة أي محتوى وتحريره قبل نشره. لا تضمن ReelSpy تحقيق أي مدى انتشار أو تفاعل أو نتيجة عمل معينة.",
        },
        thirdPartyPlatforms: {
          heading: "8. المنصات الخارجية",
          body: "تتصل ReelSpy بالمنصات التي تُصرّح بها عبر واجهاتها البرمجية الرسمية. يبقى استخدامك لتلك المنصات خاضعًا لشروطها الخاصة، وتوافرها أو تغييرات واجهاتها البرمجية خارجة عن سيطرتنا. نحن غير مسؤولين عن أي إجراءات تتخذها تلك المنصات على حسابك.",
        },
        cancellation: {
          heading: "9. الإلغاء والإنهاء",
          before:
            "يمكنك التوقف عن استخدام ReelSpy وحذف حسابك في أي وقت من الإعدادات، مما يزيل بياناتك على النحو الموضح في ",
          after:
        ...
        disclaimers: {
          ...
          body: "تُقدَّم الخدمة «كما هي» دون أي ضمانات من أي نوع. إلى أقصى حد يسمح به القانون، لا تتحمل ReelSpy مسؤولية الأضرار غير المباشرة أو العرضية أو التبعية، وتقتصر مسؤوليتنا الإجمالية عن أي مطالبة على المبلغ الذي دفعته لنا خلال الأشهر الثلاثة السابقة للمطالبة.",
        },
        governingLaw: {
    ...
    cookies: {
      ...
      metaDescription: "كيف ولماذا تستخدم ReelSpy ملفات تعريف الارتباط والتخزين المحلي.",
      updatedDate: "2026-06-15",
      intro:
        "توضح سياسة ملفات تعريف الارتباط هذه كيفية استخدام ReelSpy لملفات تعريف الارتباط والتقنيات المشابهة (مثل التخزين المحلي للمتصفح) للتعرف عليك عند استخدامك لتطبيقنا.",
      sections: {
        whatAreCookies: {
          heading: "ما هي ملفات تعريف الارتباط؟",
          body: "ملفات تعريف الارتباط هي ملفات نصية صغيرة تُوضع على جهازك عند زيارتك لموقع إلكتروني. تُستخدم على نطاق واسع لتشغيل التطبيقات، وإبقائك مسجّلًا للدخول، وتذكّر تفضيلاتك.",
        },
        howWeUse: {
          ...
          essential: {
            label: "أساسية",
            body: "ملفات تعريف ارتباط للمصادقة والجلسات تُبقيك مسجّلًا للدخول وتؤمّن حسابك. لا يمكن للتطبيق العمل بدونها.",
          },
          preferences: {
            label: "التفضيلات",
        ...
        managingChoices: {
          ...
          body: "عند زيارتك لـ ReelSpy لأول مرة، يتيح لك شريط إشعار قبول ملفات تعريف الارتباط غير الأساسية أو رفضها. يمكنك تغيير قرارك في أي وقت بمسح تخزين المتصفح الخاص بهذا الموقع. تتيح لك معظم المتصفحات أيضًا حظر ملفات تعريف الارتباط أو حذفها من خلال إعداداتها، مع أن حظر الملفات الأساسية قد يمنعك من تسجيل الدخول.",
        },
        moreInfo: {
