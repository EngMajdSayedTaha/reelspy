...
const en = {
  accounts: {
    ...
    import: {
      ...
      introPart2: "file from Instagram's Accounts Center →",
      downloadLinkText: "Export your information",
      introPart3: "(the request can take a few minutes). You'll review the list before anything is added.",
...
export const accountsAr: AccountsDict = {
  accounts: {
    ...
    import: {
      ...
      introPart2: "من مركز حسابات إنستغرام ←",
      downloadLinkText: "تصدير بياناتك",
      introPart3: "(قد يستغرق الطلب بضع دقائق). ستراجع القائمة قبل إضافة أي شيء.",
