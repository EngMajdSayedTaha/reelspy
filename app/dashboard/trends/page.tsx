    ...
    <div className="space-y-6">
      <header className="space-y-1">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold text-foreground">Niche Radar</h1>
        </div>
        <p className="max-w-2xl text-sm text-muted-foreground">
          What&apos;s over-performing right now across every ReelSpy user&apos;s tracked
          accounts — ranked relative to each account&apos;s own baseline, so a rising niche
          account can beat a giant one. Anonymized aggregate intelligence.
        </p>
      </header>
      ...
      {reels.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-border bg-card p-10 text-center">
          <p className="text-sm font-medium text-foreground">Nothing trending here yet</p>
          <p className="mx-auto mt-1 max-w-md text-sm text-muted-foreground">
            The radar fills in as accounts are tracked and synced across the userbase. Track
            more accounts and check back — recent over-performers will surface here.
          </p>
        </div>
      ) : (
